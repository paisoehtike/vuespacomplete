  ...
  <div class="order-container">
    ...
    <div class="customer-info-row">
      <CustomerInfo>
        ...
        <TableRow v-if="detail && detail.previous_address" :label="'From Address'" :value="detail.previous_address" :type="'request-detail'"></TableRow>
        <TableRow :label="'Township'" :value="detail.customer_detail.township.name" :type="'request-detail'"></TableRow>
        <TableRow v-if="detail && detail.type == 'installation'" :label="'Address'" :value="detail.address" :type="'request-detail'"></TableRow>
        <TableRow v-else-if="detail && detail.type == null" :label="'Address'" :value="detail.address ? detail.address : '-'" :type="'request-detail'"></TableRow>
        <TableRow v-else :label="'To Address'" :value="detail.address" :type="'request-detail'"></TableRow>
        <!-- <TableRow
